...
LineItem.create(:project_id => p1.id, :product_id => Product.find_by_key(:trans_de_it),   :quantity => 3000,    :modifier => 25)
LineItem.create(:project_id => p1.id, :product_id => Product.find_by_key(:trans_de_it),   :quantity => 2200,    :modifier => 25)

LineItem.create(:project_id => p2.id, :product_id => Product.find_by_key(:trans_de_it),   :quantity => 2400,    :modifier => -29)

LineItem.create(:project_id => p3.id, :product_id => Product.find_by_key(:trans_en_it),   :quantity => 8200)
LineItem.create(:project_id => p3.id, :product_id => Product.find_by_key(:consulting),    :quantity => 4)
LineItem.create(:project_id => p3.id, :product_id => Product.find_by_key(:voucher),       :quantity => 25)

LineItem.create(:project_id => p4.id, :product_id => Product.find_by_key(:trans_de_it),   :quantity => 600,    :modifier => -29)
LineItem.create(:project_id => p4.id, :product_id => Product.find_by_key(:trans_de_it),   :quantity => 1700,   :modifier => -29)
LineItem.create(:project_id => p4.id, :product_id => Product.find_by_key(:trans_en_it),   :quantity => 85,     :modifier => -29)
LineItem.create(:project_id => p4.id, :product_id => Product.find_by_key(:proof_it),      :quantity => 500,    :modifier => -29)

LineItem.create(:project_id => p5.id, :product_id => Product.find_by_key(:trans_en_it),   :quantity => 4000,    :modifier => -25)
LineItem.create(:project_id => p5.id, :product_id => Product.find_by_key(:layout_word),   :quantity => 4000,    :modifier => 20)

LineItem.create(:project_id => p6.id, :product_id => Product.find_by_key(:trans_de_it),   :quantity => 2450,    :modifier => -25)

LineItem.create(:project_id => p7.id, :product_id => Product.find_by_key(:base),          :quantity => 1)
LineItem.create(:project_id => p7.id, :product_id => Product.find_by_key(:trans_de_it),   :quantity => 890,     :modifier => 25)
LineItem.create(:project_id => p7.id, :product_id => Product.find_by_key(:trans_de_it),   :quantity => 2200,    :modifier => 25)
