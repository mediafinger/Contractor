...
ActiveRecord::Schema.define(version: 20121229002621) do
  ...
  add_index "invoices", ["until"], name: "index_invoices_on_until", using: :btree
  ...
  add_index "products", ["key"], name: "index_products_on_key", unique: true, using: :btree
  ...
  add_index "statuses", ["key"], name: "index_statuses_on_key", unique: true, using: :btree
